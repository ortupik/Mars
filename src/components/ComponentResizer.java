...
public class ComponentResizer extends MouseAdapter
{
	...
	private static boolean isBeingReaized;
	...
	public void mouseMoved(MouseEvent e)
	{
		...
		Component source = new MediaShare().getMainFrame();
		...
		else  // use the appropriate resizable cursor
		{
			...
			isBeingReaized =true;
			new MediaShare().setResizeCursor(cursor);
	...
	protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current)
	{
		//  Start with original locaton and size
		 ...
		 source = new MediaShare().getMainFrame();
	...
	public static Boolean getisBeingReaized(){
		return isBeingReaized;

...
public class VideoAdjustPanel extends MediaShare {
    ...
    public VideoAdjustPanel(MediaPlayer mediaPlayer) {
        this.mediaPlayerComponent = embeddedMediaPlayerComponent1;

        enableCheckBox = new JCheckBox("dialog.effects.tabs.video.adjust.enable");

        hueLabel = new JLabel();
        hueLabel.setText(("dialog.effects.tabs.video.adjust.hue"));
        ...
        brightnessLabel.setText(("dialog.effects.tabs.video.adjust.brightness"));
        ...
        contrastLabel.setText(("dialog.effects.tabs.video.adjust.contrast"));
        ...
        saturationLabel.setText(("dialog.effects.tabs.video.adjust.saturation"));
        ...
        gammaLabel.setText(("dialog.effects.tabs.video.adjust.gamma"));
